        ...
        <div class="card">
            <div class="card-header">
                <div class="col-12">
                    <div class="row">
                        <div class="col-6">
                            <a href="{{ route('attendanceList') }}" class="btn btn-outline-primary"><i class="fas fa-angle-left me-2"></i>Back</a>
                        </div>
                        <div class="col-6">
                            <h2 class="text-end">Attendance Form</h2>
                        </div>
                    </div>
                </div>
            </div>
            <div class="card-body">
                <form action="{{ route('attendanceOperation') }}" method="post" class="row" enctype="multipart/form-data">
                    @csrf
                    <div class="col-10 py-2 px-2">
                        ...
                        <div class="col-12">
                            <div class="d-flex justify-content-center align-items-center py-2">
                                ...
                                <input type="date" class="form-control" placeholder="Ex, demo client" name="clockInDate">
                            </div>
                        </div>
                        ...
                        @else
                          ...
                          <div class="col-12 d-none">
                            <div class="d-flex justify-content-center align-items-center py-2">
                                ...
                                <input type="text" class="form-control" placeholder="Ex, demo client" name="companyTimeIn" value="{{ $selectCompanyDatas->companyTimeIn }}">
                            </div>
                        </div> 
                        @endif
                        {{--  --}}
                        ...
                        <div class="col-12">
                            <div class="d-flex justify-content-center align-items-center py-2">
                                ...
                                <input type="time" class="form-control" placeholder="Ex, 2024-02-06 13:50:09" name="clockInTime">
                            </div>
                        </div>
                        {{--  --}}
                        {{--  --}}
                        <div class="col-12">
                            <div class="d-flex justify-content-center align-items-start py-2">
                                ...
                                <textarea name="lateNotes" id="lateNotes" cols="30" rows="5" class="form-control" placeholder="Ex, Reason"></textarea>
                            </div>
                        </div>
                        {{--  --}}
                    </div>
