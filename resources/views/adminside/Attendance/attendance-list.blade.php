            ...
            <div class="card-body">
                <div class="col-12 py-2">
                    <div class="py-2 d-flex justify-content-end align-items-center">
                        ...
                        <a href="{{ route('addNewAttendancePage') }}" class="btn btn-outline-primary mx-2"><i class="mx-2 fas fa-plus"></i>Add More</a>
                    </div>
                    <table class="table">
                        <thead>
                            <tr>
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right" style="">
                                                  <a class="dropdown-item" href="{{ route('attendanceEditPage',$selectEmployeess->id) }}"><i class="fas fa-edit mx-2"></i> Edit</a>
                                                  <a class="dropdown-item" href="{{ route('removeAttendanceDetails',$selectEmployeess->id) }}"><i class="fas fa-trash mx-2"></i> Delete</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
