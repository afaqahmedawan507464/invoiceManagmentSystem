...
<head>
    ...
    <title>Scope Visions | Employee Edit</title>
</head>
<body>
    <div class="container mt-2">
       ...
       <div class="alert alert-danger alert-dismissible fade show px-4 d-flex justify-content-center flex-column" role="alert">
        ...
        <div class="card">
            <div class="card-header">
                <div class="col-12">
                    <div class="row">
                        ...
                        <div class="col-6">
                            <h2 class="text-end">Update Employee</h2>
                        </div>
                    </div>
                </div>
            </div>
            ...
            @endforeach
            <div class="card-body">
                <form action="{{ route('updateEmployeeOperation',$selectEmployees->id) }}" method="post" class="row" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="col-10 py-2 px-2">
                        ...
                        <div class="col-12">
                            <div class="d-flex justify-content-center align-items-center py-2">
                                ...
                                <input type="text" class="form-control" placeholder="Ex, demo employee" name="employeeName" value="{{ $selectEmployees->employeename }}">
                            </div>
                        </div>
                        {{--  --}}
                        <div class="col-12">
                            <div class="d-flex justify-content-center align-items-center py-2">
                                ...
                                <input type="email" class="form-control" placeholder="Ex, abc@abc.com" name="employeeEmailAddress" value="{{ $selectEmployees->employeeemailaddress }}">
                            </div>
                        </div>
                        {{--  --}}
                        <div class="col-12">
                            <div class="d-flex justify-content-center align-items-center py-2">
                                ...
                                <select name="employeeType" id="employeeType" class="form-control">
                                    ...
                                    <option value="service eng">Service Engr</option>
