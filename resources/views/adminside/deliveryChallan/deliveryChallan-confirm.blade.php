...
<html lang="en-US" dir="ltr">
  ...
  <head>
    ...
    <!--    Document Title-->
    <!-- ===============================================-->
    <title>Scope Visions | Confirm Form</title>
      ...
      <div class="container" data-layout="container">
        ...
        <div class="row min-vh-100 bg-100">
          <div class="col-6 d-none d-lg-block position-relative">
            <div class="bg-holder" style="background-image:url(/themes/public/assets/img/generic/14.jpg);background-position: 50% 20%;">
            </div>
            <!--/.bg-holder-->
                  ...
                  <div class="row justify-content-center">
                    <div class="col-auto">
                      <div class="d-flex align-items-center">
                        <div class="flex-1">
                          <h4>Hi! {{ Auth::guard('admin')->user()->adminname }}</h4>
                          <p class="mb-0">Enter your password <br />to access the admin function.</p>
                        </div>
                      </div>
                      @foreach ($selectQuotation as $selectQuotations)
                          
                      @endforeach
                      <form class="mt-4 row gx-2" method="post" action="{{ route('lockscreenDeliveryChallan',$selectQuotations->id) }}">
                        @csrf
                        <div class="col">
                          <input class="form-control" name="password" type="password" placeholder="Password"  />
                        </div>
                        <div class="col d-none">
                          <input class="form-control" type="text" placeholder="Password" aria-label="User's password" aria-describedby="user-password" value="{{ $selectQuotations->id }}"/>
                        </div>
                        <div class="col-4">
                          <button class="btn btn-outline-primary  d-block w-100"  type="submit">Login</button>
                        </div>
                      </form>
                    </div>
                  </div>
