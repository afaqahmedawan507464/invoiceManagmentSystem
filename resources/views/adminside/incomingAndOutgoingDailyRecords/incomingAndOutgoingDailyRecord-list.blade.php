    ...
    <div class="container mt-2">
       ...
       <div class="alert alert-danger alert-dismissible fade show px-4 d-flex justify-content-center flex-column" role="alert">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('searchDataaa') }}" method="post" class="d-flex justify-content-center align-items-center">
                    @csrf
                                            ...
                                            <div class="col-12">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right" style="">
                                                    ...
                                                    @if ( ! empty ($selectIncomingAndOutgoingDailyRecords->outgoing_date ) )
                                                      <a class="dropdown-item" href="{{ route('removeScopeDailyInomingAndOutgoingRecord',$selectIncomingAndOutgoingDailyRecords->id) }}"><i class="fas fa-trash mx-2"></i> Delete</a>
                                                    @else
                                                      <a class="dropdown-item" href="{{ route('incomingAndOutGoingDailyRecordEditPage',$selectIncomingAndOutgoingDailyRecords->id) }}"><i class="fas fa-edit mx-2"></i> Edit</a>
                                                    @endif
                                                    @else
                                                      <a class="dropdown-item" href="{{ route('withoutTjfInspectionOutgoingCreatingPage',$selectIncomingAndOutgoingDailyRecords->incoming_report_ids) }}"><i class="fas fa-clock mx-2"></i> Create Outgoing Inspection</a>
                                                    @endif
                                                </div>
                                            </div>
                                        </div>
