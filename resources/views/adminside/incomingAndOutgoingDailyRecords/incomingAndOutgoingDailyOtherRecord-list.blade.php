    ...
    <div class="container mt-2">
       ...
       <div class="alert alert-danger alert-dismissible fade show px-4 d-flex justify-content-center flex-column" role="alert">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('searchOperationIncomingAndOutgoingDataDailyRecord') }}" method="post" class="d-flex justify-content-center align-items-center">
                    @csrf
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right" style="">
                                                    ...
                                                    <a class="dropdown-item" href="{{ route('detailIncomingAndOutgoingDataDailyRecordPage',$selectIncomingAndOutgoingDailyRecords->id) }}"><i class="fas fa-user mx-2"></i> View Detail</a>
                                                    <a class="dropdown-item" href="{{ route('removeOperationIncomingAndOutgoingDataDailyRecord',$selectIncomingAndOutgoingDailyRecords->id) }}"><i class="fas fa-trash mx-2"></i> Delete</a>
                                                    @else
                                                    <a class="dropdown-item" href="{{ route('editIncomingAndOutgoingDataDailyRecordPage',$selectIncomingAndOutgoingDailyRecords->id) }}"><i class="fas fa-edit mx-2"></i> Edit</a>
                                                    @endif
                                                </div>
                                            </div>
                                        </div>
            ...
            <div class="modal-body">
              <div class="row d-flex justify-content-center align-items-center">
                    <div class="col-5 p-2 mx-1">
                        <a href="{{ route('createPageDisposibleIncomingAndOutgoingDaily') }}" class="btn btn-outline-primary">Incoming Record For Disposible</a>
                    </div>
                    <div class="col-5 p-2 mx-1">
                        <a href="{{ route('createDataIncomingAndOutgoingDailyCreatingPage') }}" class="btn btn-outline-primary">Incoming Record For Others</a>
                    </div>
              </div>
            </div>
          </div>
