    ...
    <div class="container mt-2">
       ...
       <div class="alert alert-danger alert-dismissible fade show px-4 d-flex justify-content-center flex-column" role="alert">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('searchOtherDatass') }}" method="post" class="d-flex justify-content-center align-items-center">
                    @csrf
                ...
                <div class="col-12 py-2">
                    <div class="py-2 d-flex justify-content-end align-items-center">
                        <a href="/createStockDisposiblePage" class="btn btn-outline-primary" ><i class="mx-2 fas fa-plus"></i>Add More</a>
                    </div>
                    <table class="table">
                        <thead>
                            <tr>
