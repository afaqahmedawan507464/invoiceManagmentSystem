       ...
       <div class="alert alert-danger alert-dismissible fade show px-4 d-flex justify-content-center flex-column" role="alert">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                @endforeach
                @if (!empty($selectDatas->incoming_report_ids))
                    <form action="{{ route('updateOperationStockScopes',$selectDatas->id) }}" method="post" class="row" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="col-10 py-2 px-2">
                            ...
                            <div class="col-12">
                                <div class="d-flex justify-content-center align-items-center py-2">
                                    ...
                                    <input type="date" class="form-control" placeholder="Ex, 0000-00-00" name="itemIncomingDate" value="{{ $selectDatas->item_incomingdate }}">
                                </div>
                            </div>
                            {{--  --}}
                            {{--  --}}
                ...
                @else
                    @if (!empty($selectDatas->item_batchNo))
                        <form action="{{ route('updateOperationStockDisposible',$selectDatas->id) }}" method="post" class="row" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="col-10 py-2 px-2">
                                <div class="row px-2 py-2">
                    ...
                    @else
                        @if (!empty($selectDatas->item_companyname))
                            <form action="{{ route('updateOperationStockOther',$selectDatas->id) }}" method="post" class="row" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                <div class="col-10 py-2 px-2">
                                    <div class="row px-2 py-2">
                        ...
                        @else
                            <form action="{{ route('updateOperationStockScopesParts',$selectDatas->id) }}" method="post" class="row" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                <div class="col-10 py-2 px-2">
                                    <div class="row px-2 py-2">
                            ...
                            <div class="d-flex justify-content-center align-items-center py-2">
                                ...
                                <input type="text" class="form-control" placeholder="Ex, 123465" name="itemPricePerUnit"  value="{{ $selectDatas->ratePerUnit }}">
                                    ...
                                    <div class="col-12">
                                        <div class="d-flex justify-content-center align-items-center py-2">
                                            <label class="text-end mx-2 mt-1" for="" style="width:300px;">Incoming Date:</label>
                                            <input type="date" class="form-control" placeholder="Ex, 0000-00-00" name="itemIncomingDate" name="itemDetails" value="{{ $selectDatas->item_incomingdate }}">
                                        </div>
                                    </div>
                                    {{--  --}}
                                    <div class="col-12">
