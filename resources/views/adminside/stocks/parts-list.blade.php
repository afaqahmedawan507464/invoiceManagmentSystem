            ...
            <div class="card-header">
                <div class="col-12">
                    <div class="row">
                        ...
                        <div class="col-6">
                            <h4 class="text-end">Stocks List ( Parts, Other, Scopes )</h4>
                        </div>
                    </div>
                </div>
            </div>
            <div class="card-body">
                <form action="{{ route('searchOtherDatas') }}" method="post" class="d-flex justify-content-center align-items-center">
                    @csrf
                ...
                <div class="col-12 py-2">
                    <div class="py-2 d-flex justify-content-end align-items-center">
                        <a href="{{ route('createNotificationQtvChecker') }}" class="btn btn-outline-primary"><i class="mx-2 fas fa-check"></i>Check Stock</a>
                        <button class="btn btn-outline-primary mx-2" data-bs-toggle="modal" data-bs-target="#exampleModal"><i class="mx-2 fas fa-plus"></i>Add More</button>
                    </div>
                    <table class="table">
                        <thead>
                            <tr>
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right" style="">
                                                  <a class="dropdown-item" href="{{ route('detailsProducts',$selectPart->id) }}"><i class="fas fa-user mx-2"></i> View Detail</a>
                                                  <a class="dropdown-item" href="{{ route('editProducts',$selectPart->id) }}"><i class="fas fa-edit mx-2"></i> Edit</a>
                                                  <a class="dropdown-item" href="{{ route('removeOperationStocksData',$selectPart->id) }}"><i class="fas fa-trash mx-2"></i> Delete</a>
                                                  <a class="dropdown-item" href="{{ route('stockHistory',$selectPart->id) }}"><i class="fas fa-history mx-2"></i> Product History</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
