                    ...
                    <table class="table">
                        ...
                        <tbody id="clientData">
                            ...
                            <tr>
                                ...
                                <td  style="width: 20%;text-align:center">
                                    <div class="d-flex">
                                            <a href="{{ route('detailInvoicePage',$selectQuotation->id) }}" id="clientDetails" class="mx-1 text-decoration-none  btn btn-outline-primary "><i class="fas fa-user"></i></a>
                                            <a href="{{ route('editPageInvoice',$selectQuotation->id) }}" id="clientEdit" class="mx-1 text-decoration-none  btn btn-outline-warning "><i class="fas fa-edit"></i></a>
                                            <a href="{{ route('removeInvoicePage',$selectQuotation->id) }}" class="mx-1 text-decoration-none  btn btn-outline-danger "><i class="fas fa-trash"></i></a>
                                            ...
                                            @else
                                            <a href="{{ route('createDeliveryChallanPage',$selectQuotation->id) }}" class="mx-1 text-decoration-none  btn btn-outline-success "><i class="fas fa-list"></i></a>
                                            {{-- @endif --}}
                                            @endif
                                            @endif
                                            @endif
                                            ...
                                            @else
                                            <a href="{{ route('createClientAccountHistoryPage',$selectQuotation->id) }}" class="mx-1 text-decoration-none  btn btn-outline-success "><i class="fas fa-dollar-sign"></i></a>
                                            @endif
                                    </div>
                                </td>
                            </tr>
