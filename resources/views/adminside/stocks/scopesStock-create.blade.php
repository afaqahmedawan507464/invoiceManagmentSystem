...
<head>
    ...
    <title>Scope Visions | New Scope Stock</title>
</head>
<body>
        ...
        <div class="card">
            <div class="card-header">
                <div class="col-12">
                    <div class="row">
                        <div class="col-6">
                            <a href="{{ route('withoutTjfInspectionIncomingListPage') }}" class="btn btn-outline-primary"><i class="fas fa-angle-left me-2"></i>Back</a>
                        </div>
                        <div class="col-6">
                            <h3 class="text-end">Create A New Stock ( Scopes )</h3>
                        </div>
                    </div>
                </div>
            </div>
            <div class="card-body">
                @if ($selectInspectionReport->isEmpty())
                    
                @else
                    @foreach ($selectInspectionReport as $selectInspectionReports)
                        
                    @endforeach
                <form action="{{ route('createStockScopes') }}" method="post" class="row" enctype="multipart/form-data">
                    @csrf
                    <div class="col-10 py-2 px-2">
                        ...
                        <div class="col-12">
                            <div class="d-flex justify-content-center align-items-start py-2">
                                ...
                                <input type="text" class="form-control" placeholder="Ex, Scope" name="itemDetails" value="{{ $selectInspectionReports->scope_model }}">
                            </div>
                        </div>
                        {{--  --}}
                        <div class="col-12 d-none">
                            <div class="d-flex justify-content-center align-items-center py-2">
                                <label class="text-end mx-2 mt-1" for="" style="width:300px;">Inspection Id:</label>
                                <input type="text" class="form-control" placeholder="Ex, 123465" name="inspectionId" value="{{ $selectInspectionReports->id }}">
                            </div>
                        </div>
                        {{--  --}}
                        <div class="col-12">
                        ...
                        <div class="col-12">
                            <div class="d-flex justify-content-center align-items-center py-2">
                                ...
                                <input type="text" class="form-control" placeholder="Ex, 12345678" name="itemSerialNo" value="{{ $selectInspectionReports->scope_sr_number }}">
                            </div>
                        </div>
                        {{--  --}}
                        <div class="col-12">
                            <div class="d-flex justify-content-center align-items-center py-2">
                                ...
                                <input type="text" class="form-control" placeholder="Ex, cf-140L" name="itemModel" value="{{ $selectInspectionReports->scope_model }}">
                            </div>
                        </div>
                        {{--  --}}
                        <div class="col-12">
                            <div class="d-flex justify-content-center align-items-center py-2">
                                ...
                                <input type="date" class="form-control" placeholder="Ex, 0000-00-00" name="itemIncomingDate" value="{{ $selectInspectionReports->scope_incoming_date }}">
                            </div>
                        </div>
                        {{--  --}}
                         {{--  --}}
                        ...
                        <div class="col-12">
                            <div class="d-flex justify-content-center align-items-center py-2">
                                ...
                                <input type="text" class="form-control" placeholder="Ex, company name" name="scopeCompanyName">
                            </div>
                        </div>
                        {{--  --}}
                    </div>
