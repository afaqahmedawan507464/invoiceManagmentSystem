        ...
        <div class="card">
            <div class="card-header">
                <div class="col-12">
                    <div class="row">
                        <div class="col-6">
                            <a href="{{ route('deliveryChallanListPage') }}" class="btn btn-outline-primary"><i class="fas fa-angle-left me-2"></i>Back</a>
                        </div>
                        <div class="col-6">
            ...
            <div class="card-body">
                ...
                @else
                    ...
                    @endforeach
                <form action="{{ route('outgoingSystemItem') }}" method="post" class="row" enctype="multipart/form-data">
                    @csrf
