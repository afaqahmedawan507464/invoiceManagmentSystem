...
<head>
    ...
    <title>Scope Visions | New Quotation Scope</title>
</head>
<body>
    <div class="container mt-2">
       ...
       <div class="alert alert-danger alert-dismissible fade show px-4 d-flex justify-content-center flex-column" role="alert">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('createQuotationRepairing_Operations') }}" method="post" class="row" enctype="multipart/form-data">
                    @csrf
                    <div class="col-10 py-2 px-2">
                        ...
                        <div class="col-12">
                            <div class="d-flex justify-content-center align-items-center py-2">
                                ...
                                <input type="text" class="form-control" placeholder="Ex, ABC123" name="quotationNumber">
                            </div>
                        </div>
                        <div class="col-12">
                            <div class="d-flex justify-content-center align-items-center py-2">
                                <label class="text-end mx-2 mt-1" for="" style="width:300px;">Quotation To:</label>
                        ...
                        <div class="col-12 d-none">
                            <div class="d-flex justify-content-center align-items-center py-2">
                                ...
                                <textarea name="quotationHeading" id="quotationHeading" class="form-control" placeholder="Ex, Data" cols="30" rows="4"></textarea>
                            </div>
                        </div>
                        {{--  --}}
                        </div>
                        ...
                        <div class="row px-2 py-2">
                            ...
                            <div class="col-12">
                                <div class="d-flex justify-content-center align-items-start py-2">
                                    ...
                                    <textarea name="quotationItemNeedWork[]" id="quotationItemNeedWork" class="form-control" placeholder="Ex, Description" cols="30" rows="5"></textarea>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="d-flex justify-content-center align-items-center py-2">
