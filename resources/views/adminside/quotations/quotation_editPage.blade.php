       ...
       <div class="alert alert-danger alert-dismissible fade show px-4 d-flex justify-content-center flex-column" role="alert">
        ...
        <div class="card">
            <div class="card-header">
                <div class="col-12">
                    <div class="row">
                        ...
                        <div class="col-12">
                            <h4 class="text-end">Edit Quotation</h4>
                        </div>
                    </div>
                </div>
            </div>
            <div class="card-body">
                    ...
                    <form action="{{ route('editQuotationRepairingOperation',$selectQuotations->id) }}" method="post" class="row" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="col-10 py-2 px-2">
                            ...
                            <div class="col-12">
                                <div class="d-flex justify-content-center align-items-center py-2">
                                    <label class="text-end mx-2 mt-1" for="" style="width:300px;">Quotation Number:</label>
                    ...
                    @else
                    <form action="{{ route('editQuotationDisposibleOperation',$selectQuotations->id) }}" method="post" class="row" enctype="multipart/form-data">
                       @csrf
                       @method('PUT')
                        <div class="col-10 py-2 px-2">
                            {{--  --}}
                    ...
                    @else
                    <form action="{{ route('updateQuotationRepairing_Operations',$selectQuotations->id) }}" method="post" class="row" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="col-10 py-2 px-2">
                            {{--  --}}
