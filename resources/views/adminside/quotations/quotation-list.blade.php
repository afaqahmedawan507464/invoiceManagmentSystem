    ...
    <div class="container mt-2">
       ...
       <div class="alert alert-danger alert-dismissible fade show px-4 d-flex justify-content-center flex-column" role="alert">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('searchQuotations') }}" method="post" class="d-flex justify-content-center align-items-center">
                    @csrf
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right" style="">
                                                  <a class="dropdown-item" href="{{ route('detailQuotationPage',$selectQuotation->id) }}"><i class="fas fa-user mx-2"></i> View Detail</a>
