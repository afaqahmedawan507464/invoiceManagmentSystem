            ...
            <div class="card-header">
                <div class="col-12">
                    <div class="row">
                        ...
                        <div class="col-6">
                            <h2 class="text-end">Quotation List (Without Logo) </h2>
                        </div>
                    </div>
                </div>
            </div>
            <div class="card-body">
                <form action="{{ route('searchQuotationsWithOut') }}" method="post" class="d-flex justify-content-center align-items-center">
                    @csrf
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right" style="">
                                                  <a class="dropdown-item" href="{{ route('detailWithOutLogoQuotationPage',$selectQuotation->id) }}"><i class="fas fa-user mx-2"></i> View Detail</a>
                                                  <a class="dropdown-item" href="{{ route('editPageQuotation',$selectQuotation->id) }}"><i class="fas fa-edit mx-2"></i> Edit</a>
                                                  <a class="dropdown-item" href="{{ route('removeQuotationPage',$selectQuotation->id) }}"><i class="fas fa-trash mx-2"></i> Delete</a>
                                                  @if (\DB::table('invoices')->where('quotation_id', '=', $selectQuotation->id)->count() > 0)
                                                  @else
                                                  <a class="dropdown-item" href="{{ route('createInvoicePage',$selectQuotation->id) }}"><i class="fas fa-file mx-2"></i> Create Invoice</a>
                                                  @endif
                                                </div>
                                            </div>
                                        </div>
        ...
        <div class="modal-body">
            <div class="d-flex justify-content-center align-items-center">
                <div class="d-flex mx-1">
                    <a href="{{ route('createDisposibleQuotationPage') }}" class="btn btn-outline-primary">Quotation For Disposible</a>
                </div>
                <div class="d-flex mx-1">
                    <a href="{{ route('createRepairingQuotationPage') }}" class="btn btn-outline-primary">Quotation For System</a>
                </div>
                <div class="d-flex mx-1">
                    <a href="{{ route('createRepairingDataSS') }}" class="btn btn-outline-primary">Quotation For Repairing</a>
                </div>
            </div>
        </div>
      </div>
