        ...
        <div class="card">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('createInvoiceRepairingOperation') }}" method="post" class="row" enctype="multipart/form-data">
                        @csrf
                        <div class="col-10 py-2 px-2">
                            ...
                            <div class="col-12">
                                <div class="d-flex justify-content-center align-items-center py-2">
                                    ...
                                    <input type="text" class="form-control" placeholder="Ex, ABC123" name="quotationNumber" value="{{ $selectQuotations->quotation_number }}">
                                </div>
                            </div>
                            ...
                            <div class="col-12">
                                <div class="d-flex justify-content-center align-items-center py-2">
                                    ...
                                    <select name="quotationClient" id="quotationClient" class="form-control">
                                        <option value="{{ $selectQuotations->client_id }}">{{ $selectQuotations->client_name }}</option>
                            ...
                            <div class="col-12 d-none">
                                <div class="d-flex justify-content-center align-items-center py-2">
                                    ...
                                    <textarea name="quotationHeading" id="quotationHeading" class="form-control" placeholder="Ex, Data" cols="30" rows="4">{{ $selectQuotations->quotation_heading }}</textarea>
                                </div>
                            </div>
                            {{--  --}}
                            </div>
                                    ...
                                    <div class="col-12 py-2">
                                        <div class="row">
                                            ...
                                            <div class="col-4 d-flex justify-content-end align-items-center">
                                                <button class="btn btn-outline-primary add_item_btn"><i class="mx-2 fas fa-plus"></i>Add More</button>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                ...
                                <div class="row px-2 py-2">
                                    <div class="col-12">
                                        <div class="d-flex justify-content-center align-items-center py-2">
                                            ...
                                            <button class="btn btn-outline-primary add_item_btn1 mx-2"><i class="mx-2 fas fa-plus"></i></button>
                                        </div>
                                    </div>
                                </div>
                                </div>
                            ...
                            <div class="col-12">
                                <div class="d-flex justify-content-center align-items-center py-2">
                                    ...
                                    <input type="text" class="form-control" placeholder="Ex, ABC123" name="quotationGstText" value="{{ $selectQuotations->quotation_gsttext }}">
                                </div>
                            </div>
                            {{--  --}}
                            {{--  --}}
                    ...
                    @else
                    <form action="{{ route('createInvoiceDisposibleOperation') }}" method="post" class="row" enctype="multipart/form-data">
                        @csrf
                        <div class="row px-2 py-2">
                            <div class="col-12">
                                <div class="d-flex justify-content-center align-items-center py-2">
                                ...
                                <div class="row px-2 py-2">
                                    <div class="col-12 py-2">
                                        <div class="row">
                                            <div class="col-8"></div>
                                            <div class="col-4 d-flex justify-content-end align-items-center">
                                                <button class="btn btn-outline-primary add_item_btn4"><i class="mx-2 fas fa-plus"></i>Add More</button>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-12">
                    ...
                    @endif   
                    @else
                    <form action="{{ route('createInvoiceRepairing_Operation') }}" method="post" class="row" enctype="multipart/form-data">
                        @csrf
                        <div class="col-10 py-2 px-2">
                            {{--  --}}
                            <h4>Invoice Basic Information</h4>
                            ...
                            <div class="row px-2 py-2">
                                ...
                                <div class="col-12 text-center"><span class="mx-2"><b>Scope Model : {{ $quotation_scope_model[$key] }}</b></span> <span class="mx-2"><b>Scope Serial Number : {{ $quotation_scope_srno[$key] }}</b></span></div>
                                <div class="col-12 d-none">
                                    <div class="d-flex justify-content-center align-items-center py-2">
                                        <label class="text-end mx-2 mt-1" for="" style="width:300px;">Serial Number:</label>
                                ...
                                <div class="col-12">
                                    <div class="d-flex justify-content-center align-items-start py-2">
                                        <label class="text-end mx-2 mt-1" for="" style="width:300px;">Need Done</label>
