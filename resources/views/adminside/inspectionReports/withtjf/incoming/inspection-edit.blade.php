...
<head>
    ...
    <title>Scope Visions | Edit Incoming Inspection</title>
</head>
<body>
       ...
       <div class="alert alert-danger alert-dismissible fade show px-4 d-flex justify-content-center flex-column" role="alert">
        ...
        <div class="card">
            <div class="card-header">
                <div class="col-12">
                    <div class="row">
                        ...
                        <div class="col-6">
                            <h3 class="text-end">Edit Incoming Inspection Report</h3>
                        </div>
                    </div>
                </div>
            </div>
            <div class="card-body">
                ...
                @endforeach
                @if  ($selectIncomingInspectionReport->scope_tjf_elevator_channel == '' ) 
                 {{-- gastro and colono scope edit operation --}}
                <form action="{{ route('updateWithoutTjfInspectionIncomingReport',$selectIncomingInspectionReport->id) }}" method="post" class="row" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                ...
                <form action="{{ route('TjfInspectionIncomingReport',$selectIncomingInspectionReport->id) }}" method="post" class="row" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="col-10 py-2 px-2">
                        <div class="row px-2 py-2">
                        ...
                        <div class="col-md-6">
                            <div class="d-flex justify-content-center align-items-center py-2">
                                ...
                                <select name="scopeElevatorChannel" id="scopeElevatorChannel" class="form-control">
                                    @if ($selectIncomingInspectionReport->scope_tjf_elevator_channel == 1)
                                    <option value="1">Ok</option>
                                    <option value="0">Not Ok</option>
                                    @else
                                    <option value="0">Not Ok</option>
                        ...
                        <div class="col-md-6">
                            <div class="d-flex justify-content-center align-items-center py-2">
                                ...
                                <select name="scopeElevatorWire" id="scopeElevatorWire" class="form-control">
                                    @if ($selectIncomingInspectionReport->scope_tjf_elevator_wire == 1)
                                    <option value="1">Ok</option>
                                    <option value="0">Not Ok</option>
                                    @else
                                    <option value="0">Not Ok</option>
                        ...
                        <div class="col-md-6">
                            <div class="d-flex justify-content-center align-items-center py-2">
                                ...
                                <select name="scopeElevatorAxel" id="scopeElevatorAxel" class="form-control">
                                    @if ($selectIncomingInspectionReport->scope_tjf_elevator_axel == 1)
                                    <option value="1">Ok</option>
                                    <option value="0">Not Ok</option>
                                    @else
                                    <option value="0">Not Ok</option>
                        ...
                        <div class="col-md-6">
                            <div class="d-flex justify-content-center align-items-center py-2">
                                ...
                                <select name="scopeTipCover" id="scopeTipCover" class="form-control">
                                    @if ($selectIncomingInspectionReport->scope_tjf_tip_cover == 1)
                                    <option value="1">Ok</option>
                                    <option value="0">Not Ok</option>
                                    @else
                                    <option value="0">Not Ok</option>
                        ...
                        <div class="col-md-6">
                            <div class="d-flex justify-content-center align-items-center py-2">
                                ...
                                <select name="scopeElevatorClinder" id="scopeElevatorClinder" class="form-control">
                                    @if ($selectIncomingInspectionReport->scope_tjf_elevator_clinder == 1)
                                    <option value="1">Ok</option>
                                    <option value="0">Not Ok</option>
                                    @else
                                    <option value="0">Not Ok</option>
                        ...
                        <div class="col-md-6">
                            <div class="d-flex justify-content-center align-items-center py-2">
                                ...
                                <select name="scopeElevatorLiver" id="scopeElevatorLiver" class="form-control">
                                    @if ($selectIncomingInspectionReport->scope_tjf_liver == 1)
                                    <option value="1">Ok</option>
                                    <option value="0">Not Ok</option>
                                    @else
                                    <option value="0">Not Ok</option>
