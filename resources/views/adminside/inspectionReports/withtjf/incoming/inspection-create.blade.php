...
<head>
    ...
    <title> Scope Visions | Incoming Inspection Creation Form</title>
</head>
<body>
    <div class="container mt-2">
       ...
       <div class="alert alert-danger alert-dismissible fade show px-4 d-flex justify-content-center flex-column" role="alert">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('withoutTjfInspectionIncomingCreateOperation') }}" method="post" class="row" enctype="multipart/form-data">
                    @csrf
