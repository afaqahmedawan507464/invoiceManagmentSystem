            ...
            <div class="card-body">
                ...
                <div class="col-12 py-2">
                    <div class="py-2 d-flex justify-content-end align-items-center">
                        {{-- <a href="{{ route('withoutTjfInspectionOutgoingCreatingPage') }}" class="btn btn-outline-primary "><i class="mx-2 fas fa-plus"></i>Add More</a> --}}
                    </div>
                    <table class="table">
                        <thead>
                            <tr>
                        ...
                        <tbody id="clientData">
                            ...
                            <tr>
                                ...
                                <td  style="width: 20%;text-align:center">
                                    <div class="d-flex">
                                            <a href="{{ route('detailsPageOutgoingGastroAndColonoScope',$selectOutGoingInspectionReport->id) }}" id="clientDetails" class="mx-1 text-decoration-none  btn btn-outline-primary "><i class="fas fa-user"></i></a>
                                            <span>
                                                <a href="{{ route('withoutTjfInspectionOutgoingEditPage',$selectOutGoingInspectionReport->id) }}" id="clientEdit" class="mx-1 text-decoration-none  btn btn-outline-warning "><i class="fas fa-edit"></i></a>
                                            </span>
                                            <span>
                                                <a href="{{ route('removeWithoutTjfInspectionOutgoingReport',$selectOutGoingInspectionReport->id) }}" class="mx-1 text-decoration-none  btn btn-outline-danger "><i class="fas fa-trash"></i></a>
                                            </span>
                                    </div>
                                </td>
                            </tr>
