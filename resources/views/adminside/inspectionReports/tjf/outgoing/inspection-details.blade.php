            ...
            <div class="row d-flex justify-content-center align-items-center">
                <div class="col-6 text-center">
                    ...
                    <div class="img-div mx-3" style="height: 100px;width: 100px;border-radius:50%;">
                        <img src="{{ $selectCompanyss->company_logo }}" alt="" style="height: 100%;width: 100%;border-radius:50%;">
                    </div>
                ...
                <div class="row mt-3">
                    <div class="col-3 py-2" style="border:0.5px solid lightgray">
                       ...
                       <input type="text" class="form-control" placeholder="enter data" style="width:100%;" value="{{ $selectIncomingReportInspections->scope_model }}" disabled >
                    </div>
                    <div class="col-3 py-2" style="border:0.5px solid lightgray">
                       <label class="my-1" style="margin-top: 5px;">Incoming Date:</label>
                       <input type="text" class="form-control" placeholder="enter data" style="width:100%;" value="{{ $selectIncomingReportInspections->scope_incoming_date  }}" disabled >
                    </div>
                    <div class="col-3 py-2" style="border:0.5px solid lightgray">
                       ...
                       <input type="text" class="form-control" placeholder="enter data" style="width:100%;" value="{{ $selectIncomingReportInspections->scope_sr_number }}" disabled >
                    </div>
                    <div class="col-3 py-2" style="border:0.5px solid lightgray">
                       ...
                       <input type="text" class="form-control" placeholder="enter data" style="width:100%;" value="{{ $selectIncomingReportInspections->sender_name }}" disabled >
                    </div>
                 ...
                 <!--  -->
                 <h5 class="text-center mt-2">Important Information Filling Scope Related</h5>
                 <!--  -->
                 <div class="row">
                 ...
                 <div class="row">
                    ...
                    <div class="col-6">
                       ...
                       <input type="text" class="form-control" placeholder="enter data" style="width:60%;" value="{{ $selectIncomingReportInspections->employeename }}" disabled >
                       </div>
                       <div class="d-flex py-2">
