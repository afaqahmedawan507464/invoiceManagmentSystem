...
<body>
    ...
    <div class="bg-white py-2">
        <div class="col-12 print">
            <form action="{{ route('getDataForMonthdetailExpensesPage') }}" method="post" class="d-flex justify-content-end align-items-center">
                @csrf
                <div>
        ...
        <div class="row pt-1 px-2 printVisible">
            ...
            <div class="col-12">
                ...
                <table style="width: 100%;">
                    <thead>
                        <tr>
                            <th class="py-2" style="width:10%;text-align:center;border:1px solid black">Date</th>
                            <th class="py-2" style="width:15%;text-align:center;border:1px solid black">Category</th>
                            <th class="py-2" style="width:30%;text-align:center;border:1px solid black">Expense Detail</th>
                            <th class="py-2" style="width:12%;text-align:center;border:1px solid black">Bill No</th>
                            <th class="py-2" style="width:8%;text-align:center;border:1px solid black">Amount</th>
                            <th class="py-2" style="width:8%;text-align:center;border:1px solid black">Total</th>
                            <th class="py-2" style="width:8%;text-align:center;border:1px solid black">Method</th>
                            <th class="py-2" style="width:9%;text-align:center;border:1px solid black">Patticash</th>
                        </tr>
                    </thead>
                    <tbody>
                    @foreach ($selectExpenses as $selectExpense)
                    <tr>
                        <td class="py-1 px-2" style="width:10%;text-align:center;border:1px solid black;font-size:12px;">{{ \Carbon\Carbon::parse($selectExpense->expense_date)->format('M d, Y')}}</td>
                        ...
                        <td class="py-1 px-2" style="width:30%;text-align:center;border:1px solid black;font-size:12px;">
                            @php
                            $expense_category_type = isset($selectExpense->expense_category_type) ? json_decode($selectExpense->expense_category_type, true) : [];
                            $expense_detail= isset($selectExpense->expense_detail) ? json_decode($selectExpense->expense_detail, true) : [];
                            @endphp
                            @foreach ($expense_category_type as $key => $expense_category_types)
                            <span>
                                {{ $expense_detail[$key] }}
                        ...
                        <td class="py-1 px-2" style="width:12%;text-align:center;border:1px solid black;font-size:12px;">
                            @php
                            $expense_category_type = isset($selectExpense->expense_category_type) ? json_decode($selectExpense->expense_category_type, true) : [];
                        ...
                        <td class="py-1 px-2" style="width:8%;text-align:center;border:1px solid black;font-size:12px;">
                            @php
                            $expense_category_type = isset($selectExpense->expense_category_type) ? json_decode($selectExpense->expense_category_type, true) : [];
                        ...
                        <td class="py-1 px-2" style="width:8%;text-align:center;border:1px solid black;font-size:12px;">{{ $selectExpense->total_use_amount }} /=</td>
                        <td class="py-1 px-2" style="width:8%;text-align:center;border:1px solid black;font-size:12px;">
                            @php
                            $expense_category_type = isset($selectExpense->expense_category_type) ? json_decode($selectExpense->expense_category_type, true) : [];
                        ...
                        <td class="py-1 px-2" style="width:9%;text-align:center;border:1px solid black;font-size:12px;">
