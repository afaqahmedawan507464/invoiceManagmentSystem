                ...
                <div class="collapse navbar-collapse" id="navbarVerticalCollapse">
                    <div class="navbar-vertical-content scrollbar">
                        <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
                            <li class="nav-item">
                                <!-- parent pages--><a class="nav-link dropdown-indicator" href="#dashboard"
                                    ...
                                    <div class="d-flex align-items-center"><span class="nav-link-icon"><span
                                                class="fas fa-check"></span></span><span
                                            class="nav-link-text ps-1">Attendance</span>
                                    </div>
                                </a>
                                <ul class="nav collapse show" id="dashboard">
                                    <li class="nav-item"><a class="nav-link"
                                            href="{{ route('attendanceEmployeesList') }}" aria-expanded="false">
                                            <div class="d-flex align-items-center"><span
                                                    class="nav-link-text ps-1">Attendance List</span>
                                            </div>
                                        </a>
                                        <!-- more inner pages-->
                                    </li>
                                    {{--  --}}
                                    <li class="nav-item"><a class="nav-link" href="{{ route('holidayLeaveLists') }}"
                                            aria-expanded="false">
                                            <div class="d-flex align-items-center"><span
                                                    class="nav-link-text ps-1">Leave List</span>
                                            </div>
                                        </a>
                                        <!-- more inner pages-->
                                    </li>
                            ...
                            {{--  --}}
                            <li class="nav-item">
                                <!-- parent pages--><a class="nav-link dropdown-indicator" href="#dashboard17"
                                    role="button" data-bs-toggle="collapse" aria-expanded="true"
                                    aria-controls="dashboard17">
                                    <div class="d-flex align-items-center"><span class="nav-link-icon"><span
                                                class="fas fa-user"></span></span><span
                                            class="nav-link-text ps-1">Employee</span>
                                    </div>
                                </a>
                                <ul class="nav collapse show" id="dashboard17">
                                    <li class="nav-item"><a class="nav-link" href="{{ route('employeeList') }}"
                                            aria-expanded="false">
                                            <div class="d-flex align-items-center"><span
                                                    class="nav-link-text ps-1">Employee List</span>
                                            </div>
                                        </a>
                                        <!-- more inner pages-->
                                    </li>
                            ...
                            <li class="nav-item">
                                <!-- parent pages--><a class="nav-link dropdown-indicator" href="#dashboard"
                                    ...
                                    aria-controls="dashboard">
                                    <div class="d-flex align-items-center"><span class="nav-link-icon"><span
                                                class="fas fa-box"></span></span><span
                                            class="nav-link-text ps-1">Stock Managment</span>
                                    </div>
                                </a>
                                <ul class="nav collapse show" id="dashboard">
                                    <li class="nav-item"><a class="nav-link"
                                            href="{{ route('stockDisposibleItemsList') }}" aria-expanded="false">
                                            <div class="d-flex align-items-center"><span
                                                    class="nav-link-text ps-1">Stock Disposible Items List</span>
                                            </div>
                                        </a>
                                        <!-- more inner pages-->
                                    </li>
                                    <li class="nav-item"><a class="nav-link"
                                            href="{{ route('otherItemsListIncludedParts') }}" aria-expanded="false">
                                            <div class="d-flex align-items-center"><span
                                                    class="nav-link-text ps-1">Stock Scope Parts And Others List</span>
                                            </div>
                                        </a>
                                        <!-- more inner pages-->
                                    </li>
                            ...
                            {{--  --}}
                            <li class="nav-item">
                                <!-- parent pages--><a class="nav-link dropdown-indicator" href="#dashboard1"
                                    role="button" data-bs-toggle="collapse" aria-expanded="true"
                                    aria-controls="dashboard1">
                                    <div class="d-flex align-items-center"><span class="nav-link-icon"><span
                                                class="fas fa-truck-loading"></span></span><span
                                            class="nav-link-text ps-1">Delivery Challan</span>
                                    </div>
                                </a>
                                <ul class="nav collapse show" id="dashboard1">
                                    <li class="nav-item"><a class="nav-link"
                                            href="{{ route('pageDeliveryChallanListPage') }}" aria-expanded="false">
                                            <div class="d-flex align-items-center"><span
                                                    class="nav-link-text ps-1">Delivery Challan List</span>
                                            </div>
                                        </a>
                                        <!-- more inner pages-->
                                    </li>
                            ...
                            {{--  --}}
                            <li class="nav-item">
                                <!-- parent pages--><a class="nav-link dropdown-indicator" href="#dashboard2"
                                    role="button" data-bs-toggle="collapse" aria-expanded="true"
                                    aria-controls="dashboard2">
                                    <div class="d-flex align-items-center"><span class="nav-link-icon"><span
                                                class="fas fa-wallet"></span></span><span
                                            class="nav-link-text ps-1">Expenses Details</span>
                                    </div>
                                </a>
                                <ul class="nav collapse show" id="dashboard2">
                                    {{--  --}}
                                    <li class="nav-item"><a class="nav-link"
                                            href="{{ route('detailsExpensesPagesss') }}" aria-expanded="false">
                                            <div class="d-flex align-items-center"><span
                                                    class="nav-link-text ps-1">Office Expenses Details</span>
                                            </div>
                                        </a>
                                        <!-- more inner pages-->
                                    </li>
                                    {{--  --}}
                                    <li class="nav-item"><a class="nav-link"
                                            href="{{ route('newOfficeExpensePage') }}" aria-expanded="false">
                                            <div class="d-flex align-items-center"><span
                                                    class="nav-link-text ps-1">Add Office Expenses</span>
                                            </div>
                                        </a>
                                        <!-- more inner pages-->
                                    </li>
                            ...
                            {{--  --}}
                            <li class="nav-item">
                                <!-- parent pages--><a class="nav-link dropdown-indicator" href="#dashboard3"
                                    role="button" data-bs-toggle="collapse" aria-expanded="true"
                                    aria-controls="dashboard3">
                                    <div class="d-flex align-items-center"><span class="nav-link-icon"><span
                                                class="fas fa-table"></span></span><span
                                            class="nav-link-text ps-1">Incoming / Outgoing Daily Record</span>
                                    </div>
                                </a>
                                <ul class="nav collapse show" id="dashboard3">
                                    <li class="nav-item"><a class="nav-link"
                                            href="{{ route('listIncomingAndOutGoingDailyRecord') }}"
                                            aria-expanded="false">
                                            <div class="d-flex align-items-center"><span
                                                    class="nav-link-text ps-1">Incoming And Outgoing Daily Report
                                                    Scopes</span>
                                            </div>
                                        </a>
                                        <!-- more inner pages-->
                                    ...
                                    <li class="nav-item"><a class="nav-link"
                                            href="{{ route('othersIncomingAndOutgoingDataDailyRecordList') }}"
                                            aria-expanded="false">
                                            <div class="d-flex align-items-center"><span
                                                    class="nav-link-text ps-1">Incoming And Outgoing Daily
                                                    Record</span>
                                            </div>
                                        </a>
                                        <!-- more inner pages-->
                            ...
                            {{--  --}}
                            <li class="nav-item">
                                <!-- parent pages--><a class="nav-link dropdown-indicator" href="#dashboard4"
                                    role="button" data-bs-toggle="collapse" aria-expanded="true"
                                    aria-controls="dashboard4">
                                    <div class="d-flex align-items-center"><span class="nav-link-icon"><span
                                                class="fas fa-wrench"></span></span><span
                                            class="nav-link-text ps-1">Inspection Reports</span>
                                    </div>
                                </a>
                                <ul class="nav collapse show" id="dashboard4">
                                    <li class="nav-item"><a class="nav-link"
                                            href="{{ route('withoutTjfScopeInspectionIncomingListPage') }}"
                                            aria-expanded="false">
                                            <div class="d-flex align-items-center"><span
                                                    class="nav-link-text ps-1">Incoming Report List</span>
                                            </div>
                                        </a>
                                        <!-- more inner pages-->
                                    </li>
                                    <li class="nav-item"><a class="nav-link"
                                            href="{{ route('withoutTjfScopesInspectionOutgoingListPage') }}"
                                            aria-expanded="false">
                                            <div class="d-flex align-items-center"><span
                                                    class="nav-link-text ps-1">Outgoing Report List</span>
                                            </div>
                                        </a>
                                        <!-- more inner pages-->
                                    </li>
                            ...
                            {{--  --}}
                            <li class="nav-item">
                                <!-- parent pages--><a class="nav-link dropdown-indicator" href="#dashboard7"
                                    role="button" data-bs-toggle="collapse" aria-expanded="true"
                                    aria-controls="dashboard7">
                                    <div class="d-flex align-items-center"><span class="nav-link-icon"><span
                                                class="fas fa-file-invoice"></span></span><span
                                            class="nav-link-text ps-1">Invoices</span>
                                    </div>
                                </a>
                                <ul class="nav collapse show" id="dashboard7">
                                    <li class="nav-item"><a class="nav-link"
                                            href="{{ route('pageInvoiceListPage') }}" aria-expanded="false">
                                            <div class="d-flex align-items-center"><span
                                                    class="nav-link-text ps-1">Logo Invoice List</span>
                                            </div>
                                        </a>
                                        <!-- more inner pages-->
                                    </li>
                                    <li class="nav-item"><a class="nav-link"
                                            href="{{ route('pageInvoiceListWithOutLogoPage') }}"
                                            aria-expanded="false">
                                            <div class="d-flex align-items-center"><span
                                                    class="nav-link-text ps-1">Invoice List</span>
                                            </div>
                                        </a>
                                        <!-- more inner pages-->
                                    </li>
                            ...
                            {{--  --}}
                            <li class="nav-item">
                                <!-- parent pages--><a class="nav-link dropdown-indicator" href="#dashboard10"
                                    role="button" data-bs-toggle="collapse" aria-expanded="true"
                                    aria-controls="dashboard10">
                                    <div class="d-flex align-items-center"><span class="nav-link-icon"><span
                                                class="fas fa-quote-left"></span></span><span
                                            class="nav-link-text ps-1">Quotations</span>
                                    </div>
                                </a>
                                <ul class="nav collapse show" id="dashboard10">
                                    <li class="nav-item"><a class="nav-link"
                                            href="{{ route('pageQuotationListPage') }}" aria-expanded="false">
                                            <div class="d-flex align-items-center"><span
                                                    class="nav-link-text ps-1">Logo Quotation List</span>
                                            </div>
                                        </a>
                                        <!-- more inner pages-->
                                    </li>
                                    <li class="nav-item"><a class="nav-link"
                                            href="{{ route('pageQuotationListWithOutLogoPage') }}"
                                            aria-expanded="false">
                                            <div class="d-flex align-items-center"><span
                                                    class="nav-link-text ps-1">Quotation List</span>
                                            </div>
                                        </a>
                                        <!-- more inner pages-->
                                    </li>
                            ...
                            {{--  --}}
                            <li class="nav-item">
                                <!-- parent pages--><a class="nav-link dropdown-indicator" href="#dashboard13"
                                    role="button" data-bs-toggle="collapse" aria-expanded="true"
                                    aria-controls="dashboard13">
                                    <div class="d-flex align-items-center"><span class="nav-link-icon"><span
                                                class="fas fa-file"></span></span><span
                                            class="nav-link-text ps-1">Service Reports</span>
                                    </div>
                                </a>
                                <ul class="nav collapse show" id="dashboard13">
                                    <li class="nav-item"><a class="nav-link"
                                            href="{{ route('pageServiceReportListPage') }}" aria-expanded="false">
                                            <div class="d-flex align-items-center"><span
                                                    class="nav-link-text ps-1">Service Report</span>
                                            </div>
                                        </a>
                                        <!-- more inner pages-->
                                    </li>
                        ...
                        <li class="nav-item dropdown"><a class="nav-link pe-0" id="navbarDropdownUser"
                                ...
                                @else
                                    <div class="avatar avatar-xl">
                                        <img class="rounded-circle"
                                            src="{{ Auth::guard('employee')->user()->user_image }}" alt="" />
                            ...
                            <div class="dropdown-menu dropdown-menu-end py-0" aria-labelledby="navbarDropdownUser">
                                <div class="bg-white dark__bg-1000 rounded-2 py-2">
                                    <a class="dropdown-item" href="{{ route('pageCreateAdminProfilePage') }}">Profile
                                        &amp; account</a>
                ...
                <footer class="footer">
                    <div class="row g-0 justify-content-between fs--2 mt-4 mb-3">
                        <div class="col-12 text-center">
                            <p class="mb-0 text-500">Software Design By Al-Muflihoon Solution <span
                                    class="d-none d-sm-inline-block">| </span><br class="d-sm-none" /> Contact :
                                +923035568729 , +923118797784 | </span><span class="d-none d-sm-inline-block">
                                </span><br class="d-sm-none" /> EmailAddress : afaq.ahmed.awan729@gmail.com </p>
                        </div>
                        <div class="col-12 text-center">
                            <p class="mb-0 text-500"></span><br class="d-sm-none" /> &copy; Copyright Scope
                                Visions</span> | <span class="d-none d-sm-inline-block">v0.0.0.1</span></p>
                        </div>
                    </div>
                </footer>
            </div>
        ...
        <div class="offcanvas-body scrollbar-overlay px-card" id="themeController">
                ...
                <div class="row gx-2">
                    <div class="col-6">
                        ...
                        <label class="btn d-inline-block btn-navbar-style fs--1" for="themeSwitcherLight"> <span
                                class="hover-overlay mb-2 rounded d-block"><img class="img-fluid img-prototype mb-0"
                                    src="/themes/public/assets/img/generic/falcon-mode-default.jpg"
                    ...
                    <div class="col-6">
                        ...
                        <label class="btn d-inline-block btn-navbar-style fs--1" for="themeSwitcherDark"> <span
                                class="hover-overlay mb-2 rounded d-block"><img class="img-fluid img-prototype mb-0"
                                    src="/themes/public/assets/img/generic/falcon-mode-dark.jpg"
            ...
            <div class="d-flex justify-content-between">
                <div class="d-flex align-items-start"><img class="me-2"
                        src="/themes/public/assets/img/icons/left-arrow-from-left.svg" width="20"
                        alt="" />
                    <div class="flex-1">
            ...
            <div class="d-flex justify-content-between">
                <div class="d-flex align-items-start"><img class="me-2"
                        src="/themes/public/assets/img/icons/arrows-h.svg" width="20" alt="" />
                    <div class="flex-1">
