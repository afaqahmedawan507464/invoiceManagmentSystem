...
<head>
    ...
    <title>Scope Visions | New Disposible Items Incoming</title>
</head>
<body>
            ...
            <div class="card-header">
                <div class="col-12">
                    <div class="row">
                        ...
                        <div class="col-12">
                            <h4 class="text-end">Incoming And Outgoing Daily Record(Disposible)</h4>
                        </div>
                    </div>
                </div>
            </div>
            <div class="card-body">
                <form action="{{ route('newCreateOperationIncomingAndOutgoingDisposibleDailyRecord') }}" method="post" class="row" enctype="multipart/form-data">
                    @csrf
                    <div class="col-10 py-2 px-2">
                        ...
                        <div class="col-12">
                            <div class="d-flex justify-content-center align-items-start py-2">
                                ...
                                <textarea name="descriptionItem" id="descriptionItem" cols="30" rows="3" class="form-control" placeholder="Ex, Alpha Numeric Data"></textarea>
                            </div>
                        </div>
                        {{--  --}}
                        <div class="col-12">
                        ...
                        <div class="col-12">
                            <div class="d-flex justify-content-center align-items-center py-2">
                                ...
                                <input type="text" class="form-control" placeholder="Ex, 123546789" name="itemBatchNumber">
                            </div>
                        </div>
                        {{--  --}}
                        <div class="col-12">
                            <div class="d-flex justify-content-center align-items-center py-2">
                                ...
                                <input type="date" class="form-control" placeholder="Ex, 123546789" name="itemExpireDate">
                            </div>
                        </div>
                        {{--  --}}
                        <div class="col-12">
                            <div class="d-flex justify-content-center align-items-center py-2">
                                ...
                                <input type="number" class="form-control" placeholder="Ex, 123546789" name="itemQty">
                            </div>
                        </div>
                        {{--  --}}
                    </div>
