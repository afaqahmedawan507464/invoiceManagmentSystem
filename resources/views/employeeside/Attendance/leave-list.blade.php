            ...
            <div class="card-header">
                <div class="col-12">
                    <div class="row">
                        ...
                        <div class="col-6">
                            <h4 class="text-end">Leave List</h4>
                        </div>
                    </div>
                </div>
            </div>
            <div class="card-body">
                <div class="col-12 py-2">
                    <div class="py-2 d-flex justify-content-end align-items-center">
                        <a href="{{ route('newLeavePage') }}" class="btn btn-outline-primary"><i class="mx-2 fas fa-plus"></i>Add More</a>
                    </div>
                </div>
                      ...
                      <div class="card-body">
                         <div class="row py-2">
                            <div class="col-12" style="padding-left: 90%;">
                                ...
                                @else
                                <div class="dropdown-menu dropdown-menu-right" style="">
                                  <a class="dropdown-item" href="{{ route('holidayLeaveDetails',$selectLeaveDatas->id) }}"> View Leave</a>
                                </div>
                                @endif
                            </div>
                            <div class="col-12">
