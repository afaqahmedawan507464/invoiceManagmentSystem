...
<head>
    ...
    <title>Scope Visions | Leave Form </title>
</head>
<body>
        ...
        <div class="card">
            <div class="card-header">
                <div class="col-12">
                    <div class="row">
                        <div class="col-6">
                            <a href="{{ route('holidayLeaveLists') }}" class="btn btn-outline-primary"><i class="fas fa-angle-left me-2"></i>Back</a>
                        </div>
                        <div class="col-6">
                            <h2 class="text-end">Leave Creation Form</h2>
                        </div>
                    </div>
                </div>
            </div>
            <div class="card-body">
                <form action="{{ route('newLeaveCreationOperation') }}" method="post" class="row" enctype="multipart/form-data">
                    @csrf
                    <div class="col-10 py-2 px-2">
                        ...
                        {{-- <div class="col-12">
                            <div class="d-flex justify-content-center align-items-center py-2">
                                ...
                                <input type="date" class="form-control" placeholder="Ex, demo client" name="leaveDate">
                            </div>
                        </div> --}}
                            ...
                            <div class="d-flex justify-content-center align-items-center py-2">
                                ...
                                <select name="employeeId" id="employeeId" class="form-control">
                                    ...
                                    @else
                                        ...
                                        <option value="{{ $selectEmployeess->id }}">{{ $selectEmployeess->employeename }}</option>
                                        @endforeach
                                    @endif
                                </select>
                            </div>
                        ...
                        <div class="col-12">
                            <div class="d-flex justify-content-center align-items-center py-2">
                                ...
                                <select name="leaveDuration" id="leaveDuration" class="form-control">
                        ...
                        <div class="col-12">
                            <div class="d-flex justify-content-center align-items-center py-2">
                                ...
                                <input type="date" class="form-control" placeholder="Ex, demo client" name="leaveStartDate">
                            </div>
                        </div>
                        {{--  --}}
                        <div class="col-12">
                            <div class="d-flex justify-content-center align-items-center py-2">
                                ...
                                <input type="date" class="form-control" placeholder="Ex, demo client" name="leaveEndingDate">
                            </div>
                        </div>
                        {{--  --}}
                        <div class="col-12">
                            <div class="d-flex justify-content-center align-items-start py-2">
                                ...
                                <textarea name="reasonLeave" id="reasonLeave" cols="30" rows="5" class="form-control" placeholder="Ex, reason in detail"></textarea>
                            </div>
                        </div>
                    </div>
                    </div>
