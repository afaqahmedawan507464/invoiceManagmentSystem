@extends('employeeside.layout.layout');
@section('employeeDashboard')
<h3 class="pb-3" style="text-transform: capitize">Welcome Mrs, {{ Auth::guard('employee')->user()->employeename }}</h3>
    ...
    <div class="col-lg-6 my-2">
        <div class="card">
            <div class="card-body">
                ...
                <div class="scrollbar-overlay" style="max-height:15rem">
