...
<head>
    ...
    <title>Scope Visions | Out System Stock</title>
</head>
<body>
        ...
        <div class="card">
            <div class="card-header">
                <div class="col-12">
                    <div class="row">
                        <div class="col-6">
                            <a href="{{ route('pageDeliveryChallanListPage') }}" class="btn btn-outline-primary"><i class="fas fa-angle-left me-2"></i>Back</a>
                        </div>
                        <div class="col-6">
                            <h3 class="text-end">Outgoing Stocks ( System )</h3>
                        </div>
                    </div>
                </div>
            </div>
            <div class="card-body">
                ...
                @else
                    ...
                    @endforeach
                <form action="{{ route('outgoingOperationSystemItem') }}" method="post" class="row" enctype="multipart/form-data">
                    @csrf
                    <div class="col-10 py-2 px-2">
                        ...
                        <div class="col-12 d-none">
                            <div class="d-flex justify-content-center align-items-center py-2">
                                ...
                                <input type="text" class="form-control" placeholder="Ex, 2mm" name="itemQtv" value="{{ $selectInvoiceDataas->delivery_challan_item_qtv}}">
                            </div>
                        </div>
                        {{-- @endforeach --}}
                        {{--  --}}
                        <div class="col-12 d-none">
                            <div class="d-flex justify-content-center align-items-center py-2">
                                ...
                                <input type="text" class="form-control" placeholder="Ex, 2mm" name="itemInvoiceId" value="{{ $selectInvoiceDataas->invoice_id }}">
                            </div>
                        </div>
                        {{--  --}}
                        <div class="col-12">
                            <div class="d-flex justify-content-center align-items-center py-2">
                                ...
                                <input type="date" class="form-control" placeholder="Ex, 2mm" name="itemOutgoingDate" value="{{ $selectInvoiceDataas->delivery_challan_date }}">
                            </div>
                        </div>
                        {{--  --}}
                    </div>
