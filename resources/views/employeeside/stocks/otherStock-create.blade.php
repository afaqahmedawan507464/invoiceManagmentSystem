...
<head>
    ...
    <title>Scope Visions | New Other Stock</title>
</head>
<body>
        ...
        <div class="card">
            <div class="card-header">
                <div class="col-12">
                    <div class="row">
                        <div class="col-6">
                            <a href="{{ route('otherItemsListIncludedParts') }}" class="btn btn-outline-primary"><i class="fas fa-angle-left me-2"></i>Back</a>
                        </div>
                        <div class="col-6">
                            <h3 class="text-end">Create A New Stock ( Others )</h3>
                        </div>
                    </div>
                </div>
            </div>
            <div class="card-body">
                <form action="{{ route('newStockOtherOperation') }}" method="post" class="row" enctype="multipart/form-data">
                    @csrf
                    <div class="col-10 py-2 px-2">
                        ...
                        <div class="col-12">
                            <div class="d-flex justify-content-center align-items-start py-2">
                                ...
                                <input type="text" class="form-control" placeholder="Ex, Washer , Light source" name="itemDetails" >
                            </div>
                        </div>
                        {{--  --}}
                        <div class="col-12">
                        ...
                        <div class="col-12">
                            <div class="d-flex justify-content-center align-items-center py-2">
                                ...
                                <input type="text" class="form-control" placeholder="Ex, 12345678" name="itemSerialNo" >
                            </div>
                        </div>
                        {{--  --}}
                        <div class="col-12">
                            <div class="d-flex justify-content-center align-items-center py-2">
                                ...
                                <input type="text" class="form-control" placeholder="Ex, cf-140L" name="itemModel" >
                            </div>
                        </div>
                        {{--  --}}
                        <div class="col-12">
                            <div class="d-flex justify-content-center align-items-center py-2">
                                ...
                                <input type="text" class="form-control" placeholder="Ex, demo company" name="itemCompanyName" >
                            </div>
                        </div>
                        {{--  --}}
                        <script>
