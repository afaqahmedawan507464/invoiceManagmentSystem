    ...
    <div class="container mt-2">
       ...
       <div class="alert alert-danger alert-dismissible fade show px-4 d-flex justify-content-center flex-column" role="alert">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('searchOtherItems') }}" method="post" class="d-flex justify-content-center align-items-center">
                    @csrf
                ...
                <div class="col-12 py-2">
                    <div class="py-2 d-flex justify-content-end align-items-center">
                        <a href="{{ route('createNotificationsQtvCheckers') }}" class="btn btn-outline-primary"><i class="mx-2 fas fa-check"></i>Check Stock</a>
          ...
          <div class="row">
            <div class="d-flex justify-content-center align-items-center">
                <div class="d-flex mx-1">
                    <a href="{{ route('newStockScopesPartsPage') }}" class="btn btn-outline-primary">New Stock For Repairing Parts</a>
                </div>
                <div class="d-flex mx-1">
                    <a href="{{ route('newStockOtherPage') }}" class="btn btn-outline-primary">New Stock For Other Items</a>
                </div>
            </div>
          </div>
        </div>
