       ...
       <div class="alert alert-danger alert-dismissible fade show px-4 d-flex justify-content-center flex-column" role="alert">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                {{-- gastro and colono --}}
                <form action="{{ route('withoutTjfOutgoingInspectionCreatingOperation') }}" method="post" class="row" enctype="multipart/form-data">
                    @csrf
                ...
                @else
                {{-- tjf --}}
                <form action="{{ route('TjfOutgoingInspectionCreatingOperation') }}" method="post" class="row" enctype="multipart/form-data">
                    @csrf
                    <div class="col-10 py-2 px-2">
                        <div class="row px-2 py-2">
                            <h5>Scope Basic Information</h5>
