            ...
            <div class="card-header">
                <div class="col-12">
                    <div class="row">
                        ...
                        <div class="col-6">
                            <h2 class="text-end">Invoice List (Without Logo)</h2>
                        </div>
                    </div>
                </div>
            </div>
            <div class="card-body">
                <form action="{{ route('searchOperationInvoicess') }}" method="post" class="d-flex justify-content-center align-items-center">
                    @csrf
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right" style="">
                                                  <a class="dropdown-item" href="{{ route('pageDetailWithOutLogoInvoicePage',$selectQuotation->id) }}"><i class="fas fa-user mx-2"></i> View Detail</a>
