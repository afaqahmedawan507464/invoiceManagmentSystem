    ...
    <div class="container mt-2">
       ...
       <div class="alert alert-danger alert-dismissible fade show px-4 d-flex justify-content-center flex-column" role="alert">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('searchOperationInvoices') }}" method="post" class="d-flex justify-content-center align-items-center">
                    @csrf
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right" style="">
                                                  <a class="dropdown-item" href="{{ route('pageDetailInvoicePage',$selectQuotation->id) }}"><i class="fas fa-user mx-2"></i> View Detail</a>
                                                  ...
                                                  @else --}}
                                                  <a class="dropdown-item" href="{{ route('pageCreateDeliveryChallanPage',$selectQuotation->id) }}"><i class="fas fa-list mx-2"></i> Create Delivery Challan</a>
                                                  {{-- @endif --}}
                                                  @endif
                                                  @endif
                                                  {{--  --}}
                                                  ...
                                                  @else
                                                  <a class="dropdown-item" href="{{ route('pageCreateClientAccountHistoryPage',$selectQuotation->id) }}"><i class="fas fa-dollar-sign mx-2"></i> Payment</a>
                                                  @endif
                                                  ...
                                                  <a class="dropdown-item" href="{{ route('pageOutgoingDataStock', $selectQuotation->id) }}"><i class="fas fa-weight-hanging mx-2"></i> Exit Product</a>
                                                  @else
                                                  @endif
                                                  @endif
                                                </div>
          ...
          <div class="row">
            <div class="d-flex justify-content-center align-items-center">
                <div class="d-flex mx-1">
                    <a href="{{ route('pageCreateDisposibleInvoicePage') }}" class="btn btn-outline-primary">Invoice For Disposible</a>
                </div>
                <div class="d-flex mx-1">
                    <a href="{{ route('pageCreateRepairingInvoicePage') }}" class="btn btn-outline-primary">Invoice For System</a>
                </div>
                <div class="d-flex mx-1">
                    <a href="{{ route('pageCreateRepairingDataSSInvoice') }}" class="btn btn-outline-primary">Invoice For Repairing</a>
                </div>
            </div>
          </div>
        </div>
