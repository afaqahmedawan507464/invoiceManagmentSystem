            ...
            <div class="card-body px-3 py-3">
                ...
                @if ($selectQuotations->invoice_scope_model == '')
                    @if ($selectQuotations->invoice_item_disposible_batchNo == '')
                        <form action="{{ route('editInvoiceRepairingOperation', $selectQuotations->id) }}" method="post"
                            ...
                            <div class="col-10 py-2 px-2">
                                    ...
                                    <div class="col-12">
                                        <div class="d-flex justify-content-center align-items-center py-2">
                                            ...
                                            <input type="text" class="form-control" placeholder="Ex, ABC123"
                                                name="quotationNumber" value="{{ $selectQuotations->invoice_number }}">
                                        </div>
                                    </div>
                                    ...
                                    @else
                                        <div class="col-12 d-none">
                                            <div class="d-flex justify-content-center align-items-center py-2">
                                                ...
                                                <input type="text" class="form-control" placeholder="Ex, ABC123"
                                                    name="quotationId" value="{{ $selectQuotations->quotation_id }}">
                                            </div>
                                        </div>
                                    @endif
                                    <div class="col-12">
                                        <div class="d-flex justify-content-center align-items-center py-2">
                                            ...
                                            <select name="quotationClient" id="quotationClient" class="form-control">
                                                <option value="{{ $selectQuotations->invoice_client_id }}">
                                    ...
                                    <div class="col-12">
                                        <div class="d-flex justify-content-center align-items-center py-2">
                                            ...
                                            <input type="date" class="form-control" placeholder="Ex, 12-12-0000"
                                                name="quotationDate" value="{{ $selectQuotations->invoice_date }}">
                                        </div>
                                    </div>
                                    <div class="col-12 d-none">
                                        <div class="d-flex justify-content-center align-items-center py-2">
                                            ...
                                            <textarea name="quotationHeading" id="quotationHeading" class="form-control" placeholder="Ex, Data" cols="30"
                                                rows="4">{{ $selectQuotations->invoice_heading }}</textarea>
                                        </div>
                                    </div>
                                    {{--  --}}
                                </div>
                                ...
                                {{--  --}}
                                @php
                                    $quotation_item_srNumber = isset($selectQuotations->invoice_item_srNumber)
                                        ? json_decode($selectQuotations->invoice_item_srNumber, true)
                                        : [];
                                    $quotation_item_description = isset($selectQuotations->invoice_item_decription)
                                        ? json_decode($selectQuotations->invoice_item_decription, true)
                                        : [];
                                    $quotation_total_price = isset($selectQuotations->invoice_total_price)
                                        ? json_decode($selectQuotations->invoice_total_price, true)
                                        : [];
                                @endphp
                                {{--  --}}
                                ...
                                {{--  --}}
                                @php
                                    $quotation_termAndConditions = isset($selectQuotations->invoice_termAndConditions)
                                        ? json_decode($selectQuotations->invoice_termAndConditions, true)
                                        : [];
                                @endphp
                                {{--  --}}
                                        ...
                                        <div class="col-12">
                                            <div class="d-flex justify-content-center align-items-center py-2">
                                                ...
                                                <input type="text" class="form-control" placeholder="Ex, ABC123"
                                                    ...
                                                    value="{{ $selectQuotations->invoice_gsttext }}">
                                            </div>
                                        </div>
                                        {{--  --}}
                                        {{--  --}}
                    ...
                    @else
                        <form action="{{ route('editInvoiceDisposibleOperation', $selectQuotations->id) }}"
                            ...
                            <div class="col-10 py-2 px-2">
                                    ...
                                    <div class="col-12">
                                        <div class="d-flex justify-content-center align-items-center py-2">
                                            ...
                                            <input type="text" class="form-control" placeholder="Ex, ABC123"
                                                ...
                                                value="{{ $selectQuotations->invoice_number }}">
                                        </div>
                                    </div>
                                    @if (empty($selectQuotations->quotation_id))
                                    @else
                                ...
                                @php
                                    ...
                                    $quotation_item_description = isset($selectQuotations->item_id)
                                        ...
                                        : [];
                                    $quotation_item_name = isset($selectQuotations->item_name)
                                        ? json_decode($selectQuotations->item_name, true)
                                        : [];
                                    $quotation_total_price = isset($selectQuotations->invoice_total_price)
                                        ? json_decode($selectQuotations->invoice_total_price, true)
                                        : [];
                                    $quotation_item_disposible_batchNo = isset(
                                        $selectQuotations->invoice_item_disposible_batchNo,
                                    )
                                        ? json_decode($selectQuotations->invoice_item_disposible_batchNo, true)
                                        : [];
                                    $quotation_item_disposible_expDate = isset(
                                        $selectQuotations->invoice_item_disposible_expDate,
                                    )
                                        ? json_decode($selectQuotations->invoice_item_disposible_expDate, true)
                                        : [];
                                    $quotation_item_disposible_qtv = isset(
                                        $selectQuotations->invoice_item_disposible_qtv,
                                    )
                                        ? json_decode($selectQuotations->invoice_item_disposible_qtv, true)
                                        : [];
                                    $quotation_item_disposible_pricePerUnit = isset(
                                        $selectQuotations->invoice_item_disposible_pricePerUnit,
                                    )
                                        ? json_decode($selectQuotations->invoice_item_disposible_pricePerUnit, true)
                                        : [];
                                @endphp
                                @foreach ($quotation_item_srNumber as $key => $quotation_item_srNumbers)
                                    <div id="add_form">
                    ...
                    @endif
                @else
                    <form action="{{ route('updateInvoiceRepairing_Operation', $selectQuotations->id) }}"
                        method="post" class="row px-3 py-2" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="col-10 py-2 px-2">
                            {{--  --}}
                            ...
                            @php
                                $quotation_item_srNumber = isset($selectQuotations->invoice_item_srNumber)
                                    ? json_decode($selectQuotations->invoice_item_srNumber, true)
                                    : [];
                                $quotation_scope_model = isset($selectQuotations->invoice_scope_model)
                                    ? json_decode($selectQuotations->invoice_scope_model, true)
                                    : [];
                                $quotation_total_price = isset($selectQuotations->invoice_total_price)
                                    ? json_decode($selectQuotations->invoice_total_price, true)
                                    : [];
                                $quotation_scope_srno = isset($selectQuotations->invoice_scope_srno)
                                    ? json_decode($selectQuotations->invoice_scope_srno, true)
                                    : [];
                                $quotation_scope_problem = isset($selectQuotations->invoice_scope_problem)
                                    ? json_decode($selectQuotations->invoice_scope_problem, true)
                                    : [];
                                $quotation_need_work = isset($selectQuotations->invoice_need_work)
                                    ? json_decode($selectQuotations->invoice_need_work, true)
                                    : [];
                            @endphp
                            {{--  --}}
                            <div id="add_form">
                        ...
                        <div class="col-12">
                            <div class="d-flex justify-content-center align-items-center py-2">
                                <label class="text-end mx-2 mt-1" for="" style="width:300px;">GST
                                    Text:</label>
                                <input type="text" class="form-control" placeholder="Ex, ABC123"
                                    name="quotationGstText" value="{{ $selectQuotations->invoice_gsttext }}">
                            </div>
                        </div>
                        {{--  --}}
                @endif
