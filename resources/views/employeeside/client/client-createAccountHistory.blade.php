       ...
       <div class="alert alert-danger alert-dismissible fade show px-4 d-flex justify-content-center flex-column" role="alert">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                {{--  --}}
                {{-- system items wala --}}
                <form action="{{ route('createOperationAccountHistorySystemOperation') }}" method="post" class="row" enctype="multipart/form-data">
                    @csrf
                ...
                <form action="{{ route('createOperationAccountHistoryDisposibleOperations') }}" method="post" class="row" enctype="multipart/form-data">
                    @csrf
                    <div class="col-10 py-2 px-2">
                        <div class="row px-2 py-2">
                ...
                <form action="{{ route('createOperationAccountHistoryRepairing_Operation') }}" method="post" class="row" enctype="multipart/form-data">
                    @csrf
                    <div class="col-10 py-2 px-2">
                        <div class="row px-2 py-2">
